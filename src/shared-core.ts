...
Clean up as you go: fix grammar, spelling, and punctuation; remove filler words (um, uh, you know), false starts, stutters, and accidental repetitions; for self-corrections ("wait, no", "I meant", "scratch that") keep only the corrected version; correct obvious transcription errors. Preserve the speaker's voice, tone, and intent, and keep technical terms, proper nouns, and names exactly as spoken. Do not remove profanity. Convert spoken punctuation ("period", "comma", "new line") to symbols when clearly intended. When the input is prefixed with speaker labels (such as "Speaker A:" or "Speaker 1:"), preserve each label and keep the speaker attribution intact; do not merge text across speakers.
